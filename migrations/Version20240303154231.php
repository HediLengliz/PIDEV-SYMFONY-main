 ...
 */
final class Version20240303154231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE insurance_request ADD user_id INT DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE insurance_request ADD CONSTRAINT FK_D6B6AA3AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_D6B6AA3AA76ED395 ON insurance_request (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE insurance_request DROP FOREIGN KEY FK_D6B6AA3AA76ED395');
        $this->addSql('DROP INDEX IDX_D6B6AA3AA76ED395 ON insurance_request');
        $this->addSql('ALTER TABLE insurance_request DROP user_id, CHANGE status status VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE life_request CHANGE chron_disease_description chron_disease_description VARCHAR(100) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE quote CHANGE services services LONGTEXT DEFAULT \'NULL\' COMMENT \'(DC2Type:array)\'');
        $this->addSql('ALTER TABLE sinister CHANGE date_sinister date_sinister DATE DEFAULT \'NULL\', CHANGE status_sinister status_sinister VARCHAR(255) DEFAULT \'NULL\'');
