 ...
 */
final class Version20240304030158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sinister CHANGE status_sinister status_sinister VARCHAR(255) DEFAULT NULL');
